...
winsorize_x = function(x, cut = 0.01){
  cut_point_top <- quantile(x, 1 - cut, na.rm = T, type=2)
  cut_point_bottom <- quantile(x, cut, na.rm = T, type = 2)
...
#'             log_path = "log/001-prepare-raw-ciq-data.Rout",
#'             open     = FALSE)
#' }
...
#'   free space for the pipeline's intermediate datasets (FactSet
#'   imports, large SQL joins, etc.).
#'
#' @examples
#' \dontrun{
